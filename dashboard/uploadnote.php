                ...
                <div class="col-lg-12">
                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Eg: DBMS SYSTEM" value="<?php if (isset($_POST['upload'])) {
                                                                                                                            echo $file_title;
                                                                                                                        } ?>" required="">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="description" class="form-control" placeholder="Eg: Write Short Discription about your notes ...." value="<?php if (isset($_POST['upload'])) {
