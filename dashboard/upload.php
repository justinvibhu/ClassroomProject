				...
				<div class="col-lg-12">
					...
					<form role="form" action="" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="text" name="title" class="form-control" placeholder="Eg: Database System ">
						</div>

						<div class="form-group">
							<label for="post_tags">Note Tags</label>
							<input type="text" name="tags" class="form-control" placeholder="Eg: Short Description about yout notes etc..">
						</div>
